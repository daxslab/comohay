...
from api.v1.views import AdViewSet, ProvinceViewSet, MunicipalityViewSet, AdSearchViewSet, USDValueView, \
...
urlpatterns = [
    ...
    path('usd-value-history/<str:start>/<str:end>/<str:freq>', USDValueHistoryView.as_view()),
    path('usd-value-history/<str:start>/<str:end>/<str:freq>', USDValueHistoryView.as_view()),
    # TODO: remove this endpoint, it is not used and the resource name should be in plural (exchange-rates)
    path(
    ...
    # TODO: try change the name of this endpoint in v2, the new name must be currencies/exchange-rates/history/...
    path(
